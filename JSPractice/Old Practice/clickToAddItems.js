...
// Purpose - reset form fields to their natural state
...
// Purpose - Clear the errors, Clear the values in the <input> elements, Hide the table of results
function resetForm() {
    clearErrors();
